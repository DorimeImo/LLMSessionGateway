...
namespace LLMSessionGateway.Application.Contracts.Ports
{
    public interface IChatBackend
    {
        ...
        Task<Result<Unit>> SendUserMessageAsync(string sessionId, string message, CancellationToken cancellationToken);
        IAsyncEnumerable<string> StreamAssistantReplyAsync(string sessionId, CancellationToken cancellationToken);
